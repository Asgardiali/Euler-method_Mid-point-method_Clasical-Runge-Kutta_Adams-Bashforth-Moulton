function varargout = midPointMethodGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @midPointMethodGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @midPointMethodGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function midPointMethodGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = midPointMethodGUI_OutputFcn(hObject, eventdata, handles) 
...
[x,y,yt]=RK2_Midpt(f,[altSinir,ustSinir],startValue,startValueY,nValue);
