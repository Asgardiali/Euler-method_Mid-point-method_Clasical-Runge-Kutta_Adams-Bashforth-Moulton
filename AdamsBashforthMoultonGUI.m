function varargout = AdamsBashforthMoultonGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AdamsBashforthMoultonGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @AdamsBashforthMoultonGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function AdamsBashforthMoultonGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = AdamsBashforthMoultonGUI_OutputFcn(hObject, eventdata, handles) 
...
[x,u]=ABM_sys('fcn',[altSinir,ustSinir],[startValue,startValueY],nValue);
