function varargout = eulerMethodGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @eulerMethodGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @eulerMethodGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function eulerMethodGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = eulerMethodGUI_OutputFcn(hObject, eventdata, handles) 
...
[x,y]=Euler(f1,f2,[altSinir,ustSinir],startValue,startValueY,nValue);
